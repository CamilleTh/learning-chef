...
action :before_compile do
 ...
 new_resource.restart_command "mkdir -p #{new_resource.application.path}/current/tmp && touch #{new_resource.application.path}/current/tmp/restart.txt" unless new_resource.restart_command
